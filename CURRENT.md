...
## Estado al 2026-07-09 — 🔥 CUARTOS ARRANCAN (octavos 8/8, día 29)

El Mundial arrancó el **11-jun**. El sistema corre **en automático**: cron GitHub Actions → fetch resultados (football-data tier gratis) → deploy-on-change a Netlify. **16avos 16/16 + octavos 8/8 CERRADOS** (M89–M96). Cierre de octavos: **M95 Argentina 3-2 Egipto** · **M96 Suiza 4-3 Colombia** (penales 4-3, cargó bien — no quedó en `winner:null`). El KO se puntúa por avance de fase — cada ronda superada por un equipo del jugador suma.

🔥 **BORIS 🥇 277 (13 exactos) — líder firme, +33 sobre el 2º.** El cierre de octavos dio **+6 parejo** a los 4 de arriba (tenían a Argentina/Suiza en el cuadro) y Jorge +0, así que **el orden quedó intacto** y **la pelea por el 🥈 (30% del pozo) sigue a 1 punto: Andrés 🥈 (244, Francia) vs Paulo 🥉 (243, España)**; **Carlos 4º (228, Portugal out)** y Jorge 5º (217, Francia). Desempate: pts → exactos → campeón → FIFA.

🔴 **Hoy 09-jul — arrancan cuartos: M97 Francia–Marruecos** (16:00, Boston) — el campeón de **Andrés + Jorge**; si Francia pasa, Andrés estira la pelea por el 🥈. **Recap de predicciones generado y abierto** (`recap/predicciones-2026-07-09.html`) para el screenshot de WhatsApp: Boris/Paulo/Andrés/Jorge hacen avanzar a Francia, Carlos "doble fallo". **M97 aún NO cargado** (lo mete el cron al terminar). **Cuartos restantes:** **M98 España–Bélgica** (10-jul, el de Boris+Paulo, suben/caen juntos) · M99 Noruega–Inglaterra (11-jul) · M100 W95 vs W96 (11-jul).

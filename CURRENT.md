...
<!-- Updated: 2026-07-06 (día 26, OCTAVOS 4/8) — SYNC + REFRESH. Retomé: local 2 commits atrás → `git pull` (HEAD fdb42e6, cron sano). Entraron por cron el 05-jul PM: **M91 Noruega 2-1 Brasil (🚨 BRASIL ELIMINADO)** + **M92 Inglaterra 3-2 México**. `refresh_dashboard.py` → tabla: **BORIS 🥇 259 (13 ex) +27 · ANDRÉS 🥈 232 · PAULO 🥉 225 · CARLOS 4º 222 · JORGE 211** (todos +6, podio intacto). Pelea por el 🥈 (30% pozo) sigue en franja de 10 pts (Andrés/Paulo/Carlos). **Storyline HOY 06-jul: M93 Portugal-España 15:00 Dallas = choque directo de campeones** (Carlos vs Boris+Paulo, uno muere y reordena el podio) · M94 USA-Bélgica 20:00 (cron auto). Narrativa + estado reescritos, sin deploy (no gasta Netlify). Recap del día pendiente de decidir (predicciones M93/M94). 0 voseo. -->
...
## Estado al 2026-07-06 — 🔥 OCTAVOS EN CURSO (4/8, día 26)

El Mundial arrancó el **11-jun**. El sistema corre **en automático**: cron GitHub Actions → fetch resultados (football-data tier gratis) → deploy-on-change a Netlify. **16avos 16/16 cerrados** (M73–M88) y **octavos 4/8** jugados (M89 Francia 1-0 Paraguay · M90 Marruecos 3-0 Canadá · **M91 Noruega 2-1 Brasil** 🚨 · **M92 Inglaterra 3-2 México**). El KO se puntúa por avance de fase — cada ronda superada por un equipo del jugador suma.

🚨 **Batacazo:** **Brasil ELIMINADO en octavos** (Noruega 2-1). Inglaterra dejó fuera a México. Ambos entraron por cron el 05-jul PM.

🔥 **BORIS 🥇 259 (13 exactos) — líder firme, +27 sobre el 2º.** El podio se mantiene tras M91/M92 (todos +6, brecha intacta): **Andrés 🥈 (232, Francia)**, **Paulo 🥉 (225, España)**, **Carlos 4º (222, Portugal)**, Jorge 5º (211). Desempate del leaderboard: pts → exactos → campeón → FIFA. La pelea real sigue por el **🥈 (30% del pozo)**: Andrés–Paulo–Carlos separados por solo 10 pts.

🔴 **Hoy 06-jul — 2 octavos, uno decisivo:** **M93 Portugal–España** (15:00 Chile, Dallas) = **choque directo de campeones** — Carlos (Portugal) vs Boris+Paulo (España): **uno de los tres campeones muere hoy** y reordena el podio · **M94 USA–Bélgica** (20:00, Seattle). El cron los carga solo al terminar. Resto de octavos: M95/M96 el 07-jul.
...
|:---:|---------|---------|:---:|:---:|:---:|
| 🥇 | **Boris Tapia V (La Casa)** | España | **259** | 13 | 🟢 |
| 🥈 | **Andrés Acosta (Colombia)** | Francia | **232** | 9 | 🟢 |
| 🥉 | Paulo Salas | España | 225 | 10 | 🟢 |
| 4 | Carlos Salgado | Portugal | 222 | 9 | 🟢 |
| 5 | Jorge Vásquez | Francia | 211 | 8 | 🟢 |
<!-- AUTO:TABLA fin -->

**La carrera en octavos (4/8):** **Boris 259 (13 exactos)** manda con **+27** sobre el 2º — liderato sólido, desempate pts → exactos → campeón → FIFA (`config/reglas-puntaje.md`). **El baile es por el 🥈 (30% del pozo):** **Andrés 🥈 (232, Francia)**, **Paulo 🥉 (225, España)** y **Carlos 4º (222, Portugal)** — los tres en una franja de 10 pts, todo por definirse en lo que queda de octavos y cuartos. Jorge 5º (211). **Dos historias de campeón:** (1) **Francia (Andrés + Jorge) YA EN CUARTOS** (ganó M89, va al M97 el 09-jul) — sostiene a Andrés en el 🥈. (2) **HOY 06-jul, M93 Portugal–España** (Dallas) = el campeón de Carlos contra el de Boris y Paulo, cara a cara: **uno de los tres campeones muere** hoy y reordena el podio.
...
*Última actualización: 2026-07-06 — día 26, OCTAVOS EN CURSO (4/8). Sync `git pull` (HEAD fdb42e6) + `refresh_dashboard.py`. Entraron M91 Noruega 2-1 Brasil (🚨 Brasil eliminado) + M92 Inglaterra 3-2 México (cron 05-jul PM). Tabla: BORIS 🥇 259 (13 ex) +27 · ANDRÉS 🥈 232 · PAULO 🥉 225 · CARLOS 4º 222 · JORGE 211 (todos +6, podio intacto). Pelea abierta por el 🥈 (Andrés/Paulo/Carlos en 10 pts). Storyline HOY: M93 Portugal-España 15:00 Dallas = choque de campeones (Carlos vs Boris+Paulo, uno muere) · M94 USA-Bélgica 20:00 (cron auto). Sin deploy. Al retomar: `git pull` → `refresh_dashboard.py` → narrativa a mano. Histórico previo abajo.*

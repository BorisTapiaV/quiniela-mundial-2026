...
## Estado al 2026-07-10 — 🔥 CUARTOS 2/4 (día 30) — vuelco del 🥈

El Mundial arrancó el **11-jun**. El sistema corre **en automático**: cron GitHub Actions → fetch resultados (football-data tier gratis) → deploy-on-change a Netlify. **16avos 16/16 + octavos 8/8 + cuartos 2/4** jugados. Los dos primeros cuartos mandaron a ambos campeones de arriba a **semis**: **M97 Francia 2-0 Marruecos** (09-jul) · **M98 España 2-1 Bélgica** (10-jul). El KO se puntúa por avance de fase — cada ronda superada por un equipo del jugador suma.

🔥 **BORIS 🥇 297 (13 exactos) — líder firme, +34 sobre el 2º.** 🔄 **Se dio vuelta el 🥈 (30% del pozo): Paulo pasó a Andrés.** Con España a semis, **Boris y Paulo sumaron +20** cada uno; **Andrés solo +10** — tenía a Francia (avanzó en M97) pero **NO a España en su semifinal**, así que falló el M98. Resultado: **Paulo 🥈 (263, España)** vs **Andrés 🥉 (254, Francia)** — venían 244 vs 243 el 09-jul, empate roto. **Jorge 4º (237, Francia)** · **Carlos 5º (228, Portugal 💀 out)**. Desempate: pts → exactos → campeón → FIFA.

🔴 **Sábado 11-jul cierran los cuartos: M99 Noruega–Inglaterra** (17:00, Miami) · **M100 Argentina–Suiza** (21:00, Kansas City). **Recap de predicciones generado** (`recap/predicciones-2026-07-11.html` + PNG): Boris y Paulo van idénticos (Inglaterra + Argentina); Andrés recupera algo si Argentina pasa (la tiene en M100) pero falla el M99; **Carlos y Jorge doble fallo en ambos** (cero posible el sábado). **Semis:** España (Boris+Paulo) y Francia (Andrés+Jorge) ya están; los rivales salen de M99/M100.
...
*Última actualización: 2026-07-09 — día 29, CUARTOS ARRANCAN (octavos 8/8). Sync `git pull` (HEAD bbfcffc) + `refresh_dashboard.py`. Entraron cerrando octavos: M95 Argentina 3-2 Egipto + M96 Suiza 4-3 Colombia (penales 4-3, cargó bien). Tabla: BORIS 🥇 277 (13 ex) +33 · ANDRÉS 🥈 244 · PAULO 🥉 243 · CARLOS 4º 228 · JORGE 217. Δ +6 parejo a los 4 de arriba (Jorge +0) → orden intacto, el 🥈 (30% pozo) sigue Andrés 244 vs Paulo 243 = 1 punto. Recap de predicciones M97 generado + abierto (`recap/predicciones-2026-07-09.html`): HOY 09-jul M97 Francia–Marruecos 16:00 Boston (cuartos, campeón de Andrés+Jorge). Mañana M98 España–Bélgica 10-jul (Boris+Paulo). M97 aún NO cargado (lo mete el cron; penales → carga manual). Sin deploy. Al retomar: `git pull` → `refresh_dashboard.py` → narrativa a mano. Histórico previo abajo.*
